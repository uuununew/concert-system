...
public class UseCashCommandTest {

    @Test
    @DisplayName("유효한 userId와 금액으로 Command를 생성할 수 있다.")
    void valid_command_success() {
        assertDoesNotThrow(() -> new UseCashCommand(1L, BigDecimal.valueOf(500)));
    }
    ...
    void null_userId_fail() {
        assertThrows(CustomException.class, () ->
                new UseCashCommand(null, BigDecimal.valueOf(500)));
    }
    ...
    void zero_userId_fail() {
        assertThrows(CustomException.class, () ->
                new UseCashCommand(0L, BigDecimal.valueOf(500)));
    }
    ...
    void non_positive_amount_fail() {
        assertThrows(CustomException.class, () ->
                new UseCashCommand(1L, BigDecimal.ZERO));

        assertThrows(CustomException.class, () ->
                new UseCashCommand(1L, BigDecimal.valueOf(-1)));
    }
}
